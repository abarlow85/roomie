...
module.exports = (function(){
	return{
		...
		create: function(req, res) {
			var message = new Message({content: req.body.content, _room: req.body._room._id, _user: req.body.user._id, _task: req.body.task._id, created_at: new Date});
			message.save(function(err, message){
				...
				Room.findOneAndUpdate({_id:req.body._room._id}, {'$push': {messages: message._id}}).exec(function(err, answers){
					if(err){
